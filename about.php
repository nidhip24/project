...
<html>
    ...
    <body>
        ...
        <div class="row">
        	<div class="container">
        		<?php
				    $empd = simplexml_load_file('developer.xml');
				    foreach ($empd as $e):
				    	$name=$e->name;
				        $title=$e->post;
				        $img = $e->img;
				    ?>
		        		<div class="col s12 m4">
							<div class="card-panel">
								<?php echo "<img src='img/$img' style='height: 150px;width: 150px;display: block;margin-left: auto;margin-right: auto;border-radius: 50%'>" ?>
								<div class="row" style="text-align: center">
									<b><h4 class="white"><?php echo $name ?></h4></b>
									<p class="orange-text"><?php echo $title ?></p>
								</div>
							</div>
						</div>    
				    <?php
